...
public class ArrayList<AnyType extends Comparable<AnyType>> implements List<AnyType> {
    ...
    public void ensureCapacity( int minCapacity ) {
         ...
         * 
         */
        if ( minCapacity > MINIMUM_CAPACITY && minCapacity > capacity) 
        	grow();
        else if ( minCapacity > MINIMUM_CAPACITY && minCapacity < (int)Math.floor( capacity/2 )&&((int)Math.floor( capacity/2 )>size)) 
        	shrink();
    ...
    public static void main( String[] args ) {
         ...
         */
         ...
         System.out.println(  list.getCapacity() +" the  capacity doesn't change " );
         list.ensureCapacity(30);
         System.out.println(  list.getCapacity() +" the  capacity doesn't change " );
         list.ensureCapacity(35);
         System.out.println( "the new capacity of list is:  "+ list.getCapacity());
         list.ensureCapacity(13);
         System.out.println( "the new capacity of list is:  "+ list.getCapacity());

         System.out.println( "Remove and ensureCapacity method has no problems" );
         System.out.println( "---------------------------------------" );
